...
enum class SchedulingStrategy : int8_t {
  ...
  // Try a heuristic schedule first and fall back to the constraint-complete
  // SDC scheduler when needed. Intended as an exploration point for new
  // scheduling heuristics while preserving broad applicability.
  HYBRID,
